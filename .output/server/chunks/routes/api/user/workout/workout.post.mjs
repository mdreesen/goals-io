...
const workout_post = defineEventHandler(async (event) => {
  ...
  try {
    ...
    await User.findOneAndUpdate({ email: user == null ? void 0 : user.email }, { $addToSet: { workout: obj } }, { new: true });
  } catch (error) {
    console.log(error);
    throw createError({
      statusCode: 401,
...
export { workout_post as default };
//# sourceMappingURL=workout.post.mjs.map
