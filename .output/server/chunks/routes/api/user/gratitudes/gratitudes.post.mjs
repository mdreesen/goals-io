...
const gratitudes_post = defineEventHandler(async (event) => {
  ...
  try {
    ...
    await User.findOneAndUpdate({ email: user == null ? void 0 : user.email }, { $addToSet: { gratitudes: obj } }, { new: true });
  } catch (error) {
    console.log(error);
    throw createError({
      statusCode: 401,
...
export { gratitudes_post as default };
//# sourceMappingURL=gratitudes.post.mjs.map
