import { defineComponent, ref, withAsyncContext, withCtx, createVNode, computed, toValue, reactive, unref, mergeProps, renderSlot, mergeModels, useSlots, useModel, watch, toRef, createBlock, createCommentVNode, openBlock, createTextVNode, toDisplayString, resolveDynamicComponent, withModifiers, Fragment, renderList, toHandlers, useSSRContext } from 'vue';
...
import { x as fetchDefaults, y as useAsyncData, z as useRequestFetch, b as useAppConfig, t as tv, f as useRoute, a as __nuxt_component_0$1, v as __nuxt_component_2$1, w as __nuxt_component_0$3, c as useLocale, g as createReusableTemplate, h as getSlotChildrenText, e as _sfc_main$8$1, i as _sfc_main$9$1, r as reactivePick, o as isArrayOfArray, m as _sfc_main$b$1, l as _sfc_main$e, p as get, q as pickLinkProps, s as _sfc_main$a$1, d as usePortal, j as useFieldGroup, k as useComponentIcons, n as createSharedComposable } from './server.mjs';
...
const _sfc_main$c = {
  ...
  setup(__props) {
    ...
    const ui = computed(() => tv({ extend: tv(theme$9), ...appConfig.ui?.container || {} }));
                    ...
                    if (_push3) {
                      ...
                      return [
                        renderSlot(_ctx.$slots, item.slot ? `${item.slot}-trailing` : "item-trailing", {
                          ...
                          item.badge !== void 0 ? (openBlock(), createBlock(_sfc_main$7, mergeProps({
                            key: 0,
                            color: "neutral",
                            variant: "outline",
                            size: item.ui?.linkTrailingBadgeSize || props.ui?.linkTrailingBadgeSize || ui.value.linkTrailingBadgeSize()
                              ...
                              if (_push5) {
                                ...
                                return [
                                  __props.orientation === "vertical" && __props.collapsed && item.children?.length && (!!props.popover || !!item.popover) ? (openBlock(), createBlock(_sfc_main$6, mergeProps({ key: 0 }, { ...popoverProps.value, ...typeof item.popover === "boolean" ? {} : item.popover || {} }, {
                                    ...
                                    _: 2
                                  }, 1040, ["ui"])) : __props.orientation === "vertical" && __props.collapsed && (!!props.tooltip || !!item.tooltip) ? (openBlock(), createBlock(_sfc_main$4, mergeProps({
                                    key: 1,
                                    text: unref(get)(item, props.labelKey)
                                  }, { ...tooltipProps.value, ...typeof item.tooltip === "boolean" ? {} : item.tooltip || {} }), {
                                    default: withCtx(() => [
...
const _sfc_main$2 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      const _component_UNavigationMenu = _sfc_main$3;
...
const __nuxt_component_0 = Object.assign(_sfc_main$2, { __name: "AppNavBar" });
...
_sfc_main$1.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/app/LineChart.vue");
  return _sfc_setup$1 ? _sfc_setup$1(props, ctx) : void 0;
};
const __nuxt_component_2 = Object.assign(_sfc_main$1, { __name: "AppLineChart" });
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  async setup(__props) {
    ...
    const userData = ref();
    const { data, pending, error } = ([__temp, __restore] = withAsyncContext(() => useFetch("/api/user/books", "$LfO9GtariX")), __temp = await __temp, __restore(), __temp);
    userData.value = data;
    console.log(data, userData);
    return (_ctx, _push, _parent, _attrs) => {
      const _component_appNavBar = __nuxt_component_0;
      const _component_UContainer = _sfc_main$c;
      const _component_appLineChart = __nuxt_component_2;
      _push(`<div${ssrRenderAttrs(_attrs)}>`);
      _push(ssrRenderComponent(_component_appNavBar, null, null, _parent));
      _push(`<h1>Welcome to the Dashboard page</h1><section>`);
      _push(ssrRenderComponent(_component_UContainer, null, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(_component_appLineChart, null, null, _parent2, _scopeId));
          } else {
            return [
              createVNode(_component_appLineChart)
            ];
          }
        }),
        _: 1
...
//# sourceMappingURL=index-Dn-qzTQT.mjs.map
