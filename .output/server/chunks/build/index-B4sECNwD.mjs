...
import { defineComponent, withAsyncContext, mergeProps, unref, computed, ref, reactive, resolveDirective, useSSRContext } from 'vue';
...
const _sfc_main$4 = /* @__PURE__ */ defineComponent({
  ...
  async setup(__props) {
    ...
    useUserSession();
    useToast();
    [__temp, __restore] = withAsyncContext(() => useFetch("/api/user/water/water", { key: "hydration" }, "$CKpAiE7sAO")), await __temp, __restore();
...
const __nuxt_component_1 = /* @__PURE__ */ Object.assign(_export_sfc(_sfc_main$4, [["__scopeId", "data-v-6e922dd8"]]), { __name: "AppTrackerHydration" });
const radius = 120;
const _sfc_main$3 = /* @__PURE__ */ defineComponent({
  ...
  async setup(__props) {
    ...
    useUserSession();
    useToast();
    [__temp, __restore] = withAsyncContext(() => useFetch("/api/user/fasting/fasting", { key: "fasting" }, "$-TgsmIuMWi")), await __temp, __restore();
...
const __nuxt_component_2 = /* @__PURE__ */ Object.assign(_export_sfc(_sfc_main$3, [["__scopeId", "data-v-2dd674dd"]]), { __name: "AppTrackerFasting" });
const _sfc_main$2 = /* @__PURE__ */ defineComponent({
  __name: "TrackerWeight",
  __ssrInlineRender: true,
  async setup(__props) {
    let __temp, __restore;
    [__temp, __restore] = withAsyncContext(() => useFetch("/api/user/weight/weight", { key: "weight" }, "$7J-sOa0v0w")), await __temp, __restore();
...
const __nuxt_component_3 = /* @__PURE__ */ Object.assign(_export_sfc(_sfc_main$2, [["__scopeId", "data-v-e973cc6d"]]), { __name: "AppTrackerWeight" });
const _sfc_main$1 = /* @__PURE__ */ defineComponent({
  __name: "TrackerWorkout",
  __ssrInlineRender: true,
  async setup(__props) {
    let __temp, __restore;
    [__temp, __restore] = withAsyncContext(() => useFetch("/api/user/workout/workout", { key: "workout" }, "$Dgs4fZDbi0")), await __temp, __restore();
    useNuxtData("workout");
    ref(false);
    ref("");
    ref(false);
...
const __nuxt_component_4 = /* @__PURE__ */ Object.assign(_export_sfc(_sfc_main$1, [["__scopeId", "data-v-b7451d29"]]), { __name: "AppTrackerWorkout" });
const _sfc_main = /* @__PURE__ */ defineComponent({
  __name: "index",
  __ssrInlineRender: true,
  async setup(__props) {
    let __temp, __restore;
    [__temp, __restore] = withAsyncContext(() => useFetch("/api/user/profile/setting", { key: "setting" }, "$rQjhMtlwVd")), await __temp, __restore();
...
//# sourceMappingURL=index-B4sECNwD.mjs.map
