...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  async setup(__props) {
    ...
    [__temp, __restore] = withAsyncContext(() => useFetch("/api/user/journal/all", { key: "all_entries" }, "$eHYXn6YZep")), await __temp, __restore();
...
//# sourceMappingURL=entries-D8vIfGCv.mjs.map
