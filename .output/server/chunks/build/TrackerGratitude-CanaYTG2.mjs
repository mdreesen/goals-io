...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  async setup(__props) {
    ...
    [__temp, __restore] = withAsyncContext(() => useFetch("/api/user/gratitudes/gratitudes", { key: "gratitudes" }, "$c1zMCs162y")), await __temp, __restore();
...
//# sourceMappingURL=TrackerGratitude-CanaYTG2.mjs.map
