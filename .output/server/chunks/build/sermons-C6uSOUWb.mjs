...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  async setup(__props) {
    ...
    [__temp, __restore] = withAsyncContext(() => useFetch("/api/user/bible/sermon/all", { key: "all_sermons" }, "$BhTGJJ3csd")), await __temp, __restore();
...
//# sourceMappingURL=sermons-C6uSOUWb.mjs.map
