import { a as useNuxtData, u as useUserSession, e as __nuxt_component_0$4, d as _sfc_main$9, j as refreshNuxtData } from './server.mjs';
...
import { defineComponent, withAsyncContext, ref, reactive, resolveDirective, unref, withCtx, createVNode, withModifiers, withDirectives, createBlock, openBlock, vModelText, useSSRContext } from 'vue';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  async setup(__props) {
    ...
    [__temp, __restore] = withAsyncContext(() => useFetch("/api/user/gratitudes/gratitudes", { key: "gratitudes", lazy: true }, "$c1zMCs162y")), await __temp, __restore();
...
//# sourceMappingURL=TrackerGratitude-D-d1YkJK.mjs.map
