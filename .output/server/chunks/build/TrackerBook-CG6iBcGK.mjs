...
import { defineComponent, withAsyncContext, ref, reactive, resolveDirective, mergeProps, unref, withCtx, createVNode, withModifiers, withDirectives, createBlock, openBlock, Fragment, renderList, toDisplayString, vModelSelect, vModelText, computed, useSSRContext } from 'vue';
...
import { _ as _sfc_main$2 } from './Drawer-sBacW_ES.mjs';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  async setup(__props) {
    ...
    [__temp, __restore] = withAsyncContext(() => useFetch("/api/user/books/books", { key: "books", lazy: true }, "$yYmDequpQz")), await __temp, __restore();
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "relative flex flex-col w-full max-w-3xl mx-auto overflow-hidden" }, _attrs))} data-v-0f59c3f2>`);
      if (unref(data)?.current.length >= 1) {
        _push(`<section data-v-0f59c3f2>`);
      ...
      _push(`<div class="flex flex-col items-center justify-center w-full mx-auto p-8 font-sans" data-v-0f59c3f2><div class="w-full relative mb-4 flex flex-col justify-center items-center gap-4" data-v-0f59c3f2>`);
      _push(ssrRenderComponent(_component_UDrawer, {
        ...
        body: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<form class="space-y-6" data-v-0f59c3f2${_scopeId}><div${ssrRenderAttrs(ssrGetDirectiveProps(_ctx, _directive_motion, { ...("inputVarient" in _ctx ? _ctx.inputVarient : unref(inputVarient))() }))} data-v-0f59c3f2${_scopeId}>`);
            _push2(ssrRenderComponent(_component_baseLabel, { text: "Kind of book" }, null, _parent2, _scopeId));
            _push2(`<select id="status-select" required class="w-full rounded-xl border border-gray-600 bg-gray-700/50 py-3 px-4 text-lg text-white shadow-lg transition-all duration-300 ease-in-out focus:outline-none focus:ring-2 focus:ring-blue-500" data-v-0f59c3f2${_scopeId}><option value="" disabled selected hidden data-v-0f59c3f2${_scopeId}>Kind of book</option><!--[-->`);
            ssrRenderList(unref(selection_book_kinds), (kind) => {
              _push2(`<option${ssrRenderAttr("value", kind.value)} data-v-0f59c3f2${ssrIncludeBooleanAttr(Array.isArray(unref(input).kind_of_book) ? ssrLooseContain(unref(input).kind_of_book, kind.value) : ssrLooseEqual(unref(input).kind_of_book, kind.value)) ? " selected" : ""}${_scopeId}>${ssrInterpolate(kind.label)}</option>`);
            });
            _push2(`<!--]--></select></div><div${ssrRenderAttrs(ssrGetDirectiveProps(_ctx, _directive_motion, { ...("inputVarient" in _ctx ? _ctx.inputVarient : unref(inputVarient))() }))} data-v-0f59c3f2${_scopeId}>`);
            _push2(ssrRenderComponent(_component_baseLabel, { text: "Title" }, null, _parent2, _scopeId));
            _push2(`<input id="text" type="text"${ssrRenderAttr("value", unref(input).book_title)} placeholder="Title" required class="w-full rounded-xl border border-gray-600 bg-gray-700/50 py-3 px-4 text-lg text-white shadow-lg transition-all duration-300 ease-in-out focus:outline-none focus:ring-2 focus:ring-blue-500" data-v-0f59c3f2${_scopeId}></div><div${ssrRenderAttrs(ssrGetDirectiveProps(_ctx, _directive_motion, { ...("inputVarient" in _ctx ? _ctx.inputVarient : unref(inputVarient))() }))} data-v-0f59c3f2${_scopeId}>`);
            _push2(ssrRenderComponent(_component_baseLabel, { text: "Author" }, null, _parent2, _scopeId));
            _push2(`<input id="text" type="text"${ssrRenderAttr("value", unref(input).book_author)} placeholder="Author" required class="w-full rounded-xl border border-gray-600 bg-gray-700/50 py-3 px-4 text-lg text-white shadow-lg transition-all duration-300 ease-in-out focus:outline-none focus:ring-2 focus:ring-blue-500" data-v-0f59c3f2${_scopeId}></div><div${ssrRenderAttrs(ssrGetDirectiveProps(_ctx, _directive_motion, { ...("inputVarient" in _ctx ? _ctx.inputVarient : unref(inputVarient))() }))} data-v-0f59c3f2${_scopeId}>`);
            _push2(ssrRenderComponent(_component_baseLabel, { text: "Notes" }, null, _parent2, _scopeId));
            _push2(`<textarea id="text" type="text" placeholder="Book notes" class="w-full rounded-xl border border-gray-600 bg-gray-700/50 py-3 px-4 text-lg text-white shadow-lg transition-all duration-300 ease-in-out focus:outline-none focus:ring-2 focus:ring-blue-500" data-v-0f59c3f2${_scopeId}>${ssrInterpolate(unref(input).notes)}</textarea></div><div class="text-center" data-v-0f59c3f2${_scopeId}>`);
...
const TrackerBook = /* @__PURE__ */ Object.assign(_export_sfc(_sfc_main, [["__scopeId", "data-v-0f59c3f2"]]), { __name: "AppTrackerBook" });

export { TrackerBook as default };
//# sourceMappingURL=TrackerBook-CG6iBcGK.mjs.map
