...
const _sfc_main$3 = /* @__PURE__ */ defineComponent({
  ...
  async setup(__props) {
    ...
    useUserSession();
    useToast();
    [__temp, __restore] = withAsyncContext(() => useFetch("/api/user/fasting/fasting", { key: "fasting", lazy: true }, "$-TgsmIuMWi")), await __temp, __restore();
...
const __nuxt_component_2 = /* @__PURE__ */ Object.assign(_export_sfc(_sfc_main$3, [["__scopeId", "data-v-f8d35e2e"]]), { __name: "AppTrackerFasting" });
const _sfc_main$2 = /* @__PURE__ */ defineComponent({
  __name: "TrackerWeight",
  __ssrInlineRender: true,
  async setup(__props) {
    let __temp, __restore;
    [__temp, __restore] = withAsyncContext(() => useFetch("/api/user/weight/weight", { key: "weight", lazy: true }, "$7J-sOa0v0w")), await __temp, __restore();
...
const __nuxt_component_3 = /* @__PURE__ */ Object.assign(_export_sfc(_sfc_main$2, [["__scopeId", "data-v-e580a384"]]), { __name: "AppTrackerWeight" });
const _sfc_main$1 = /* @__PURE__ */ defineComponent({
  __name: "TrackerWorkout",
  __ssrInlineRender: true,
  async setup(__props) {
    let __temp, __restore;
    [__temp, __restore] = withAsyncContext(() => useFetch("/api/user/workout/workout", { key: "workout", lazy: true }, "$Dgs4fZDbi0")), await __temp, __restore();
    useNuxtData("workout");
    ref(false);
    ref("");
    ref(false);
...
const __nuxt_component_4 = /* @__PURE__ */ Object.assign(_export_sfc(_sfc_main$1, [["__scopeId", "data-v-61eabd49"]]), { __name: "AppTrackerWorkout" });
const _sfc_main = /* @__PURE__ */ defineComponent({
  __name: "index",
  __ssrInlineRender: true,
  async setup(__props) {
    let __temp, __restore;
    [__temp, __restore] = withAsyncContext(() => useFetch("/api/user/profile/setting", { key: "setting", lazy: true }, "$rQjhMtlwVd")), await __temp, __restore();
...
//# sourceMappingURL=index-2HjS1_c_.mjs.map
