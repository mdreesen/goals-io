...
const __nuxt_component_1_lazy_visible = createLazyVisibleComponent("components/app/TrackerBook.vue", () => import('./TrackerBook-BuqZ7aQO.mjs').then((c) => c.default || c));
const __nuxt_component_2_lazy_visible = createLazyVisibleComponent("components/app/TrackerGratitude.vue", () => import('./TrackerGratitude-CanaYTG2.mjs').then((c) => c.default || c));
const _sfc_main = /* @__PURE__ */ defineComponent({
  __name: "index",
  __ssrInlineRender: true,
  async setup(__props) {
    let __temp, __restore;
    [__temp, __restore] = withAsyncContext(() => useFetch("/api/user/profile/setting", { key: "setting" }, "$xgYqRkLRx-")), await __temp, __restore();
...
//# sourceMappingURL=index-Dwt5RIK-.mjs.map
