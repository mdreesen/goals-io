...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  async setup(__props) {
    ...
    [__temp, __restore] = withAsyncContext(() => useFetch("/api/user/bible/sermon", { key: "sermon" }, "$GzYWx1L6vs")), await __temp, __restore();
...
//# sourceMappingURL=TrackerBibleSermon-D3zZ3if3.mjs.map
