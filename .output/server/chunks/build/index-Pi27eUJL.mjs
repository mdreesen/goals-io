...
import { b as useNuxtData, a as useUserSession, c as __nuxt_component_1$1 } from './server.mjs';
import { _ as __nuxt_component_0$3 } from './Header-92UjPXQ8.mjs';
import { _ as _sfc_main$1$1, a as __nuxt_component_2$1 } from './Icon-8aWUErQK.mjs';
import { _ as _sfc_main$8 } from './Container-BLpvCicu.mjs';
...
const _sfc_main$4 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { emit: __emit }) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      }, _attrs))} data-v-44aa972a><button class="${ssrRenderClass([{ "border-white/20": unref(isOpen) }, "group flex items-center gap-2 pl-4 pr-3 py-2 backdrop-blur-sm border rounded-full transition-all duration-300 hover:bg-zinc-800"])}" data-v-44aa972a><span class="text-sm font-medium transition-colors tabular-nums" data-v-44aa972a>${ssrInterpolate(unref(useYear)().year)}</span>`);
      _push(ssrRenderComponent(unref(ChevronDown), {
        class: ["w-4 h-4 transition-transform duration-300", { "-rotate-180": unref(isOpen) }]
      }, null, _parent));
      _push(`</button>`);
      if (unref(isOpen)) {
        _push(`<div class="absolute top-full left-0 mt-2 w-32 max-h-60 backdrop-blur-xl border border-white/10 rounded-2xl shadow-xl overflow-hidden flex flex-col" data-v-44aa972a><div class="overflow-y-auto scrollbar-hide py-1" data-v-44aa972a><!--[-->`);
        ssrRenderList(useData.value, (year) => {
          _push(`<button${ssrRenderAttr("data-active", year === __props.modelValue)} class="${ssrRenderClass([year === __props.modelValue ? "text-white bg-white/5" : "text-zinc-500 hover:text-zinc-300", "w-full text-left px-4 py-2.5 text-sm transition-colors relative flex items-center justify-between group"])}" data-v-44aa972a><span class="font-medium" data-v-44aa972a>${ssrInterpolate(year)}</span>`);
          if (year === __props.modelValue) {
            _push(`<span class="w-1.5 h-1.5 rounded-full bg-white shadow-[0_0_8px_rgba(255,255,255,0.5)]" data-v-44aa972a></span>`);
          } else {
            _push(`<!---->`);
          }
          _push(`</button>`);
...
const __nuxt_component_0 = /* @__PURE__ */ Object.assign(_export_sfc(_sfc_main$4, [["__scopeId", "data-v-44aa972a"]]), { __name: "BaseButtonYear" });
function o$1(n) {
...
//# sourceMappingURL=index-Pi27eUJL.mjs.map
