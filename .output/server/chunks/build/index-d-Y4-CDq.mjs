import { defineComponent, computed, unref, withCtx, createVNode, mergeProps, createBlock, createCommentVNode, openBlock, toDisplayString, useSlots, renderSlot, ref, useSSRContext, useTemplateRef, createElementBlock, normalizeStyle, createElementVNode, Fragment, renderList } from 'vue';
import { ssrRenderAttrs, ssrRenderComponent, ssrInterpolate, ssrRenderClass, ssrRenderSlot, ssrRenderList, ssrRenderAttr } from 'vue/server-renderer';
import { a as useNuxtData, d as __nuxt_component_0$3, u as useUserSession, c as __nuxt_component_0$5, b as useAppConfig, t as tv, _ as __nuxt_component_0$3$1 } from './server.mjs';
...
const __nuxt_component_0$2 = Object.assign(_sfc_main$9, { __name: "BaseDescription" });
...
const __nuxt_component_0$1 = Object.assign(_sfc_main$8, { __name: "AppWelcome" });
const theme = {
  "slots": {
...
const _sfc_main$6 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    const props = __props;
    return (_ctx, _push, _parent, _attrs) => {
      const _component_Icon = __nuxt_component_0$3$1;
...
const __nuxt_component_3_lazy_visible = createLazyVisibleComponent("../node_modules/@nuxt/ui/dist/runtime/components/Container.vue", () => import('./Container-BnDUX6j9.mjs').then((c) => c.default || c));
...
//# sourceMappingURL=index-d-Y4-CDq.mjs.map
