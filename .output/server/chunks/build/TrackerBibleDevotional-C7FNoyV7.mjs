...
import { defineComponent, withAsyncContext, ref, reactive, resolveDirective, unref, withCtx, createVNode, withModifiers, withDirectives, createBlock, openBlock, Fragment, renderList, toDisplayString, vModelSelect, vModelText, useSSRContext } from 'vue';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  async setup(__props) {
    ...
    [__temp, __restore] = withAsyncContext(() => useFetch("/api/user/bible/devotional", { key: "devotional" }, "$K9eSE3ehd4")), await __temp, __restore();
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(_component_baseButtonDrawer, {
              text: "Add devotional entry",
              icon: "material-symbols:shield-spark-rounded"
            }, null, _parent2, _scopeId));
            _push2(ssrRenderComponent(_component_baseButtonNav, { path: "/dashboard/spirit/all/devotionals" }, null, _parent2, _scopeId));
          } else {
            return [
              ...
              createVNode(_component_baseButtonNav, { path: "/dashboard/spirit/all/devotionals" })
            ];
          }
        }),
        _: 1
...
//# sourceMappingURL=TrackerBibleDevotional-C7FNoyV7.mjs.map
