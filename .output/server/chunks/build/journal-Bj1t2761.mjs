...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  async setup(__props) {
    ...
    const { data, pending: pending_data } = ([__temp, __restore] = withAsyncContext(() => useFetch(`/api/user/journal/${route.params.id}`, { lazy: true }, "$0N9kfdtjww")), __temp = await __temp, __restore(), __temp);
...
//# sourceMappingURL=journal-Bj1t2761.mjs.map
