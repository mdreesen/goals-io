import { defineComponent, withAsyncContext, computed, mergeProps, withCtx, unref, createVNode, createBlock, createCommentVNode, openBlock, mergeModels, useSlots, useModel, watch, toRef, renderSlot, createTextVNode, toDisplayString, resolveDynamicComponent, withModifiers, Fragment, renderList, shallowRef, toHandlers, reactive, useSSRContext } from 'vue';
...
import { Primitive, useForwardPropsEmits, AccordionTrigger, AccordionItem, NavigationMenuItem, NavigationMenuTrigger, NavigationMenuLink, NavigationMenuContent, AccordionContent, AccordionRoot, NavigationMenuRoot, NavigationMenuList, NavigationMenuIndicator, NavigationMenuViewport, DialogRoot, DialogContent, VisuallyHidden, DialogTitle, DialogDescription, DialogClose, DialogTrigger, DialogPortal, DialogOverlay, TooltipRoot, TooltipTrigger, TooltipPortal, TooltipContent, TooltipArrow } from 'reka-ui';
import { n as defu } from '../nitro/nitro.mjs';
import { m as useRoute, u as useHead, f as __nuxt_component_0$3, l as __nuxt_component_2$1, L as useState, A as useLocale, h as useAppConfig, B as getSlotChildrenText, t as tv, e as _sfc_main$9$1, C as _sfc_main$a$1, r as reactivePick, H as isArrayOfArray, F as _sfc_main$c, j as _sfc_main$f, I as get, J as pickLinkProps, K as _sfc_main$b$1, y as makeDestructurable, p as usePortal, D as useFieldGroup, E as useComponentIcons, z as camelize, G as createSharedComposable } from './server.mjs';
import _sfc_main$b from './Container-CJ5Ys2DY.mjs';
import { _ as _sfc_main$a } from './Drawer-CnjHbgeP.mjs';
                    ...
                    if (_push3) {
                      ...
                      return [
                        renderSlot(_ctx.$slots, item.slot ? `${item.slot}-trailing` : "item-trailing", {
                          ...
                          __props.orientation === "horizontal" && (item.children?.length || !!slots[item.slot ? `${item.slot}-content` : "item-content"]) || __props.orientation === "vertical" && item.children?.length ? (openBlock(), createBlock(_sfc_main$f, {
                            key: 1,
                            name: item.trailingIcon || __props.trailingIcon || unref(appConfig).ui.icons.chevronDown,
                            "data-slot": "linkTrailingIcon",
                            class: ui.value.linkTrailingIcon({ class: [props.ui?.linkTrailingIcon, item.ui?.linkTrailingIcon], active })
                          }, null, 8, ["name", "class"])) : item.trailingIcon ? (openBlock(), createBlock(_sfc_main$f, {
                            key: 2,
                            name: item.trailingIcon,
                            "data-slot": "linkTrailingIcon",
                            class: ui.value.linkTrailingIcon({ class: [props.ui?.linkTrailingIcon, item.ui?.linkTrailingIcon], active })
              ...
              renderSlot(_ctx.$slots, item.slot || "item", {
                ...
                renderSlot(_ctx.$slots, item.slot ? `${item.slot}-leading` : "item-leading", {
                  ...
                  item.avatar ? (openBlock(), createBlock(_sfc_main$c, mergeProps({
                    ...
                    "data-slot": "linkLeadingAvatar",
                    class: ui.value.linkLeadingAvatar({ class: [props.ui?.linkLeadingAvatar, item.ui?.linkLeadingAvatar], active, disabled: !!item.disabled })
                  }), null, 16, ["size", "class"])) : item.icon ? (openBlock(), createBlock(_sfc_main$f, {
                    key: 1,
                    name: item.icon,
                    "data-slot": "linkLeadingIcon",
                    class: ui.value.linkLeadingIcon({ class: [props.ui?.linkLeadingIcon, item.ui?.linkLeadingIcon], active, disabled: !!item.disabled })
              ...
              default: withCtx((_, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  if (__props.orientation === "vertical" && item.type === "label" && !__props.collapsed) {
                    ...
                    _push3(ssrRenderComponent(_sfc_main$a$1, mergeProps(__props.orientation === "vertical" && item.children?.length && !__props.collapsed && item.type === "trigger" ? {} : unref(pickLinkProps)(item), { custom: "" }), {
                              ...
                              if (_push5) {
                                if (__props.orientation === "vertical" && __props.collapsed && item.children?.length && (!!props.popover || !!item.popover)) {
                                  _push5(ssrRenderComponent(_sfc_main$5, mergeProps({ ...popoverProps.value, ...typeof item.popover === "boolean" ? {} : item.popover || {} }, {
                                      ...
                                      if (_push6) {
                                        ssrRenderSlot(_ctx.$slots, item.slot ? `${item.slot}-content` : "item-content", {
                                          ...
                                          ssrRenderList(item.children, (childItem, childIndex) => {
                                            ...
                                            _push6(ssrRenderComponent(_sfc_main$a$1, mergeProps({ ref_for: true }, unref(pickLinkProps)(childItem), { custom: "" }), {
                                                ...
                                                if (_push7) {
                                                  _push7(ssrRenderComponent(unref(NavigationMenuLink), {
                                                    ...
                                                    default: withCtx((_3, _push8, _parent8, _scopeId7) => {
                                                      if (_push8) {
                                                        _push8(ssrRenderComponent(_sfc_main$b$1, mergeProps({ ref_for: true }, childSlotProps, {
                                                          "data-slot": "childLink",
                                                          ...
                                                          default: withCtx((_4, _push9, _parent9, _scopeId8) => {
                                                            if (_push9) {
                                                              if (childItem.icon) {
                                                                _push9(ssrRenderComponent(_sfc_main$f, {
                                                                  name: childItem.icon,
                                                              ...
                                                              return [
                                                                childItem.icon ? (openBlock(), createBlock(_sfc_main$f, {
                                                                  key: 0,
                                                                  name: childItem.icon,
                                                                  "data-slot": "childLinkIcon",
                                                                  class: ui.value.childLinkIcon({ class: [props.ui?.childLinkIcon, item.ui?.childLinkIcon], active: childActive })
                                                                ...
                                                                createVNode("span", {
                                                                  ...
                                                                  childItem.target === "_blank" && __props.externalIcon !== false ? (openBlock(), createBlock(_sfc_main$f, {
                                                                    key: 0,
                                                                    name: typeof __props.externalIcon === "string" ? __props.externalIcon : unref(appConfig).ui.icons.external,
                                                                    "data-slot": "childLinkLabelExternalIcon",
                                                                    class: ui.value.childLinkLabelExternalIcon({ class: [props.ui?.childLinkLabelExternalIcon, item.ui?.childLinkLabelExternalIcon], active: childActive })
                                                        ...
                                                        return [
                                                          createVNode(_sfc_main$b$1, mergeProps({ ref_for: true }, childSlotProps, {
                                                            "data-slot": "childLink",
                                                            class: ui.value.childLink({ class: [props.ui?.childLink, item.ui?.childLink, childItem.class], active: childActive })
                                                          }), {
                                                            default: withCtx(() => [
                                            ...
                                            createVNode("ul", {
                                              ...
                                              (openBlock(true), createBlock(Fragment, null, renderList(item.children, (childItem, childIndex) => {
                                                return openBlock(), createBlock("li", {
                                                  ...
                                                  createVNode(_sfc_main$a$1, mergeProps({ ref_for: true }, unref(pickLinkProps)(childItem), { custom: "" }), {
                                    ...
                                    default: withCtx((_3, _push6, _parent6, _scopeId5) => {
                                      if (_push6) {
                                        _push6(ssrRenderComponent(_sfc_main$b$1, mergeProps(slotProps, {
                                          "data-slot": "link",
                                  ...
                                  _push5(ssrRenderComponent(_sfc_main$b$1, mergeProps(slotProps, {
                                    "data-slot": "link",
                                ...
                                return [
                                  __props.orientation === "vertical" && __props.collapsed && item.children?.length && (!!props.popover || !!item.popover) ? (openBlock(), createBlock(_sfc_main$5, mergeProps({ key: 0 }, { ...popoverProps.value, ...typeof item.popover === "boolean" ? {} : item.popover || {} }, {
                                    ...
                                    _: 2
                                  }, 1040, ["text"])) : (openBlock(), createBlock(_sfc_main$b$1, mergeProps({ key: 2 }, slotProps, {
                                    "data-slot": "link",
                                    class: ui.value.link({ class: [props.ui?.link, item.ui?.link, item.class], active: active || item.active, disabled: !!item.disabled, level: __props.orientation === "horizontal" || level > 0 })
                                  }), {
                                    default: withCtx(() => [
                                ...
                                if (_push5) {
                                  ssrRenderSlot(_ctx.$slots, item.slot ? `${item.slot}-content` : "item-content", {
                                    ...
                                    ssrRenderList(item.children, (childItem, childIndex) => {
                                      ...
                                      _push5(ssrRenderComponent(_sfc_main$a$1, mergeProps({ ref_for: true }, unref(pickLinkProps)(childItem), { custom: "" }), {
                                          ...
                                          if (_push6) {
                                            _push6(ssrRenderComponent(unref(NavigationMenuLink), {
                                              ...
                                              default: withCtx((_3, _push7, _parent7, _scopeId6) => {
                                                if (_push7) {
                                                  _push7(ssrRenderComponent(_sfc_main$b$1, mergeProps({ ref_for: true }, childSlotProps, {
                                                    "data-slot": "childLink",
                                                    class: ui.value.childLink({ class: [props.ui?.childLink, item.ui?.childLink, childItem.class], active: childActive })
                                                  }), {
                                                    default: withCtx((_4, _push8, _parent8, _scopeId7) => {
                                                      if (_push8) {
                                                        if (childItem.icon) {
                                                          _push8(ssrRenderComponent(_sfc_main$f, {
                                                            name: childItem.icon,
                                                            "data-slot": "childLinkIcon",
                                                            class: ui.value.childLinkIcon({ class: [props.ui?.childLinkIcon, item.ui?.childLinkIcon], active: childActive })
                  ...
                  return [
                    ...
                    ], 2)) : item.type !== "label" ? (openBlock(), createBlock(_sfc_main$a$1, mergeProps({ key: 1 }, __props.orientation === "vertical" && item.children?.length && !__props.collapsed && item.type === "trigger" ? {} : unref(pickLinkProps)(item), { custom: "" }), {
                ...
                if (_push3) {
                  ...
                  if (unref(colorMode).value !== "light") {
                    _push3(ssrRenderComponent(_component_NuxtImg, {
                      class: "h-25 w-25 opacity-60 -left-14.5 relative rounded-full object-cover lg:hidden",
                  ...
                  return [
                    ...
                    unref(colorMode).value !== "light" ? (openBlock(), createBlock(_component_NuxtImg, {
                      key: 0,
                      class: "h-25 w-25 opacity-60 -left-14.5 relative rounded-full object-cover lg:hidden",
                      alt: "White Raven Logo",
                      format: "webp",
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  async setup(__props) {
    ...
    [__temp, __restore] = withAsyncContext(() => useFetch("/api/stats", { key: "stats", lazy: true }, "$_mpkqLPzyj")), await __temp, __restore();
    [__temp, __restore] = withAsyncContext(() => useFetch("/api/charts/books", { key: "chart_book", lazy: true }, "$9QdW1yLAUZ")), await __temp, __restore();
    [__temp, __restore] = withAsyncContext(() => useFetch("/api/charts/water", { key: "chart_hydration", lazy: true }, "$p5JQGq97On")), await __temp, __restore();
    [__temp, __restore] = withAsyncContext(() => useFetch("/api/charts/weight", { key: "chart_weight", lazy: true }, "$JM3-AuSMJ0")), await __temp, __restore();
    [__temp, __restore] = withAsyncContext(() => useFetch("/api/charts/workouts", { key: "chart_workout", lazy: true }, "$naBNDQQB8S")), await __temp, __restore();
    [__temp, __restore] = withAsyncContext(() => useFetch("/api/user/water/water", { key: "hydration", lazy: true }, "$V5AC42aInm")), await __temp, __restore();
    [__temp, __restore] = withAsyncContext(() => useFetch("/api/user/fasting/fasting", { key: "fasting", lazy: true }, "$vn5IbJ_owl")), await __temp, __restore();
    [__temp, __restore] = withAsyncContext(() => useFetch("/api/user/weight/weight", { key: "weight", lazy: true }, "$ad2mLt8uL6")), await __temp, __restore();
    [__temp, __restore] = withAsyncContext(() => useFetch("/api/user/workout/workout", { key: "workout", lazy: true }, "$3ozrDyvkUz")), await __temp, __restore();
    [__temp, __restore] = withAsyncContext(() => useFetch("/api/user/books/books", { key: "books", lazy: true }, "$EBAPtzbHxB")), await __temp, __restore();
    [__temp, __restore] = withAsyncContext(() => useFetch("/api/user/gratitudes/gratitudes", { key: "gratitudes", lazy: true }, "$AnRKo-5Ixl")), await __temp, __restore();
    [__temp, __restore] = withAsyncContext(() => useFetch("/api/user/journal/journal", { key: "journal", lazy: true }, "$axFWFe_j92")), await __temp, __restore();
    [__temp, __restore] = withAsyncContext(() => useFetch("/api/user/bible/devotional", { key: "devotional", lazy: true }, "$S5K8iwnmFG")), await __temp, __restore();
    [__temp, __restore] = withAsyncContext(() => useFetch("/api/user/bible/sermon", { key: "sermon", lazy: true }, "$LsljYWduDB")), await __temp, __restore();
    [__temp, __restore] = withAsyncContext(() => useFetch("/api/user/profile", { key: "profile", lazy: true }, "$-srpdBt1B9")), await __temp, __restore();
    [__temp, __restore] = withAsyncContext(() => useFetch("/api/user/profile/setting", { key: "setting", lazy: true }, "$AKxjgjR2xM")), await __temp, __restore();
    return (_ctx, _push, _parent, _attrs) => {
...
//# sourceMappingURL=authenticated-B8hGoD2l.mjs.map
