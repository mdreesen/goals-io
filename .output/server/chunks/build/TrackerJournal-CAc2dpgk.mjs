...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  async setup(__props) {
    ...
    [__temp, __restore] = withAsyncContext(() => useFetch("/api/user/journal/journal", { key: "journal" }, "$veQ4EUSzfu")), await __temp, __restore();
...
//# sourceMappingURL=TrackerJournal-CAc2dpgk.mjs.map
