...
const _sfc_main$6 = /* @__PURE__ */ defineComponent({
  ...
  async setup(__props) {
    ...
    [__temp, __restore] = withAsyncContext(() => useFetch("/api/user/profile", { key: "profile", lazy: true }, "$Vj7nXTHUSu")), await __temp, __restore();
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  async setup(__props) {
    ...
    [__temp, __restore] = withAsyncContext(() => useFetch("/api/charts/books", { key: "chart_book", lazy: true }, "$LfO9GtariX")), await __temp, __restore();
    [__temp, __restore] = withAsyncContext(() => useFetch("/api/charts/water", { key: "chart_hydration", lazy: true }, "$KMKYIrndvK")), await __temp, __restore();
    [__temp, __restore] = withAsyncContext(() => useFetch("/api/charts/weight", { key: "chart_weight", lazy: true }, "$SDIVj1M84F")), await __temp, __restore();
    [__temp, __restore] = withAsyncContext(() => useFetch("/api/charts/workouts", { key: "chart_workout", lazy: true }, "$qASg8yHiFN")), await __temp, __restore();
    [__temp, __restore] = withAsyncContext(() => useFetch("/api/user/profile/setting", { key: "setting", lazy: true }, "$WP_QjALZe2")), await __temp, __restore();
...
//# sourceMappingURL=index-CG2HeBAo.mjs.map
