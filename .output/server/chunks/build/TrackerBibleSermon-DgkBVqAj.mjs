...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  async setup(__props) {
    ...
    [__temp, __restore] = withAsyncContext(() => useFetch("/api/user/bible/sermon", { key: "sermon", lazy: true }, "$GzYWx1L6vs")), await __temp, __restore();
...
//# sourceMappingURL=TrackerBibleSermon-DgkBVqAj.mjs.map
