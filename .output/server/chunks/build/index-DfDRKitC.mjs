...
import { a as useUserSession, b as useAppConfig, r as reactivePick, i as useFormField, t as tv, j as _sfc_main$e } from './server.mjs';
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      ssrRenderList(toggleItems, (item, index) => {
        _push(`<div class="flex justify-between items-center bg-gray-800 p-4 sm:p-6 rounded-xl shadow-lg border border-gray-700 hover:bg-gray-700 transition duration-300"><div class="flex flex-col"><span class="text-xl font-medium">${ssrInterpolate(item.title)}</span><!--[-->`);
        ssrRenderList(item.toggles, (toggle) => {
          _push(`<div><span class="text-sm text-gray-400 mt-1 max-w-lg">${ssrInterpolate(toggle.description)}</span>`);
...
//# sourceMappingURL=index-DfDRKitC.mjs.map
