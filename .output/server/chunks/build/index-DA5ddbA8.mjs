import { a as useNuxtData, b as __nuxt_component_0, _ as __nuxt_component_0$5 } from './server.mjs';
...
const _sfc_main$4 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "flex flex-col items-center justify-center w-full mx-auto p-8" }, _attrs))} data-v-5e87a6d2><div class="relative w-64 h-64 group cursor-pointer select-none" data-v-5e87a6d2><div class="${ssrRenderClass([{ "border-emerald-500/30 shadow-[0_0_40px_rgba(16,185,129,0.2)]": isComplete.value }, "absolute inset-0 rounded-full border border-neutral-800 transition-colors duration-500"])}" data-v-5e87a6d2></div><div class="absolute inset-2 rounded-full overflow-hidden bg-neutral-900 border-4 border-neutral-900 shadow-inner transform transition-transform active:scale-95 duration-200" data-v-5e87a6d2><div class="absolute inset-0 flex flex-col items-center justify-center z-10 mix-blend-difference pointer-events-none" data-v-5e87a6d2><span class="text-6xl font-bold text-white tabular-nums tracking-tighter" data-v-5e87a6d2>${ssrInterpolate(currentOz.value)}</span><span class="text-sm font-medium text-neutral-400 mt-1" data-v-5e87a6d2> Goal ${ssrInterpolate(userDailyGoal.value)} oz </span></div><div class="absolute left-0 w-full h-full transition-all duration-1000 ease-in-out" style="${ssrRenderStyle({ top: `${wavePosition.value}%` })}" data-v-5e87a6d2><div class="wave absolute left-1/2 -top-[160%] w-[200%] h-[200%] -ml-[100%] rounded-[40%] bg-white opacity-10 animate-spin-slow" data-v-5e87a6d2></div><div class="wave absolute left-1/2 -top-[165%] w-[200%] h-[200%] -ml-[100%] rounded-[45%] bg-blue-500 animate-spin-medium" data-v-5e87a6d2></div></div>`);
      if (isComplete.value) {
        _push(`<div class="absolute inset-0 z-20 flex items-center justify-center bg-emerald-500/20 backdrop-blur-[2px]" data-v-5e87a6d2><div class="bg-emerald-500 text-black p-3 rounded-full shadow-lg animate-pop" data-v-5e87a6d2>`);
        _push(ssrRenderComponent(unref(Check), { class: "w-8 h-8 stroke-3" }, null, _parent));
        _push(`</div></div>`);
      } else {
        _push(`<!---->`);
      }
      _push(`</div></div><div class="mt-12 w-full relative" data-v-5e87a6d2><div class="flex flex-col items-center justify-center gap-8 w-full top-0 left-0" data-v-5e87a6d2><div class="flex items-center text-center gap-4" data-v-5e87a6d2><button class="w-12 h-12 rounded-full flex items-center justify-center border border-neutral-800 text-neutral-500 hover:text-white hover:border-neutral-600 transition-colors focus:outline-none" aria-label="Remove water" data-v-5e87a6d2>`);
      _push(ssrRenderComponent(unref(Minus), { class: "w-5 h-5" }, null, _parent));
      _push(`</button><div data-v-5e87a6d2><button class="w-16 h-16 rounded-2xl bg-white text-black hover:bg-neutral-200 active:scale-90 transition-all duration-200 flex items-center justify-center shadow-[0_0_20px_rgba(255,255,255,0.1)]" data-v-5e87a6d2>`);
      _push(ssrRenderComponent(unref(Plus), { class: "w-8 h-8" }, null, _parent));
      _push(`</button><span class="text-[10px] text-neutral-500 font-medium" data-v-5e87a6d2>+8oz</span></div><div data-v-5e87a6d2><button class="w-16 h-16 rounded-2xl bg-white text-black hover:bg-neutral-200 active:scale-90 transition-all duration-200 flex items-center justify-center shadow-[0_0_20px_rgba(255,255,255,0.1)]" data-v-5e87a6d2>`);
      _push(ssrRenderComponent(unref(Plus), { class: "w-8 h-8" }, null, _parent));
      _push(`</button><span class="text-[10px] text-neutral-500 font-medium" data-v-5e87a6d2>+12oz</span></div><div data-v-5e87a6d2><button class="w-16 h-16 rounded-2xl bg-white text-black hover:bg-neutral-200 active:scale-90 transition-all duration-200 flex items-center justify-center shadow-[0_0_20px_rgba(255,255,255,0.1)]" data-v-5e87a6d2>`);
      _push(ssrRenderComponent(unref(Plus), { class: "w-8 h-8" }, null, _parent));
      _push(`</button><span class="text-[10px] text-neutral-500 font-medium" data-v-5e87a6d2>+18oz</span></div><button class="w-12 h-12 rounded-full flex items-center justify-center border border-neutral-800 text-neutral-500 hover:text-white hover:border-neutral-600 transition-colors focus:outline-none" aria-label="Remove water" data-v-5e87a6d2>`);
      _push(ssrRenderComponent(unref(Plus), { class: "w-5 h-5" }, null, _parent));
      _push(`</button></div><form class="w-full text-center max-w-md" data-v-5e87a6d2>`);
...
const __nuxt_component_1 = /* @__PURE__ */ Object.assign(_export_sfc(_sfc_main$4, [["__scopeId", "data-v-5e87a6d2"]]), { __name: "AppTrackerHydration" });
const radius = 120;
...
const __nuxt_component_3 = /* @__PURE__ */ Object.assign(_export_sfc(_sfc_main$2, [["__scopeId", "data-v-9e1eb381"]]), { __name: "AppTrackerWeight" });
...
const __nuxt_component_4 = /* @__PURE__ */ Object.assign(_export_sfc(_sfc_main$1, [["__scopeId", "data-v-4a51fdbc"]]), { __name: "AppTrackerWorkout" });
...
//# sourceMappingURL=index-DA5ddbA8.mjs.map
