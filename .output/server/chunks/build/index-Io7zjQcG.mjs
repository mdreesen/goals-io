import { _ as _sfc_main$4 } from './Drawer-C3Qjdyst.mjs';
import { u as useNuxtData, b as useUserSession, d as _sfc_main$9, e as __nuxt_component_0$3, j as refreshNuxtData, g as useAppConfig, r as reactivePick, h as useFormField, t as tv, i as _sfc_main$f } from './server.mjs';
import { _ as __nuxt_component_5 } from './Label-DcsIrBrT.mjs';
import { _ as __nuxt_component_6$1 } from './ButtonSubmit-CrJNqEUh.mjs';
import { defineComponent, mergeProps, ref, reactive, resolveDirective, withCtx, createVNode, unref, withModifiers, withDirectives, createBlock, openBlock, vModelText, createTextVNode, mergeModels, useSlots, useModel, useId, computed, Fragment, createCommentVNode, renderSlot, toDisplayString, resolveDynamicComponent, useSSRContext } from 'vue';
...
import { f as formatDate, t as timeZone } from './date-DqBAJ_np.mjs';
...
const __nuxt_component_6 = /* @__PURE__ */ Object.assign(_export_sfc(_sfc_main$2, [["__scopeId", "data-v-f9c1c55e"]]), { __name: "BaseDeleteProfile" });
const name = "nuxt-app";
const type = "module";
const version = "0.1.1.9";
...
const _sfc_main$1 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      const _component_baseButtonSubmit = __nuxt_component_6$1;
      const _component_USwitch = _sfc_main$3;
      const _component_NuxtLink = __nuxt_component_0$3;
      const _component_baseDeleteProfile = __nuxt_component_6;
      ...
      _push(`<!--]--></div></div></section><div class="flex flex-col mt-4 pt-8 border-t border-gray-700 text-gray-400"><span>Date: ${ssrInterpolate(unref(formatDate)())}</span><span>Time zone: ${ssrInterpolate(unref(timeZone)())}</span><span>Version: ${ssrInterpolate(unref(packageJson).version)}</span>`);
...
//# sourceMappingURL=index-Io7zjQcG.mjs.map
