import { defineComponent, computed, unref, withCtx, createVNode, mergeProps, createBlock, createCommentVNode, openBlock, toDisplayString, ref, useSSRContext, useSlots, useTemplateRef, createElementBlock, normalizeStyle, createElementVNode, Fragment, renderList, renderSlot } from 'vue';
...
import { b as useNuxtData, d as __nuxt_component_5, a as useUserSession, c as __nuxt_component_1$1 } from './server.mjs';
import { _ as __nuxt_component_0$3 } from './Header-92UjPXQ8.mjs';
import { _ as _sfc_main$1$1, a as __nuxt_component_2$1 } from './Icon-Chw_rL4k.mjs';
import { _ as _sfc_main$8 } from './Container-VwnSa0AT.mjs';
...
const _sfc_main$4 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { emit: __emit }) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      }, _attrs))} data-v-bc5701fa><button class="${ssrRenderClass([{ "bg-zinc-800 border-white/20": unref(isOpen) }, "group flex items-center gap-2 pl-4 pr-3 py-2 backdrop-blur-sm border rounded-full transition-all duration-300 hover:bg-zinc-800"])}" data-v-bc5701fa><span class="text-sm font-medium transition-colors tabular-nums" data-v-bc5701fa>${ssrInterpolate(unref(useYear)().year)}</span>`);
      _push(ssrRenderComponent(unref(ChevronDown), {
        class: ["w-4 h-4 transition-transform duration-300", { "-rotate-180": unref(isOpen) }]
      }, null, _parent));
      _push(`</button>`);
      if (unref(isOpen)) {
        _push(`<div class="absolute top-full left-0 mt-2 w-32 max-h-60 bg-zinc-900/90 backdrop-blur-xl border border-white/10 rounded-2xl shadow-xl overflow-hidden flex flex-col" data-v-bc5701fa><div class="overflow-y-auto scrollbar-hide py-1" data-v-bc5701fa><!--[-->`);
        ssrRenderList(props.data, (year) => {
          _push(`<button${ssrRenderAttr("data-active", year === __props.modelValue)} class="${ssrRenderClass([year === __props.modelValue ? "text-white bg-white/5" : "text-zinc-500 hover:text-zinc-300 hover:bg-white/5", "w-full text-left px-4 py-2.5 text-sm transition-colors relative flex items-center justify-between group"])}" data-v-bc5701fa><span class="font-medium" data-v-bc5701fa>${ssrInterpolate(year)}</span>`);
          if (year === __props.modelValue) {
            _push(`<span class="w-1.5 h-1.5 rounded-full bg-white shadow-[0_0_8px_rgba(255,255,255,0.5)]" data-v-bc5701fa></span>`);
          } else {
            _push(`<!---->`);
          }
          _push(`</button>`);
...
const __nuxt_component_0 = /* @__PURE__ */ Object.assign(_export_sfc(_sfc_main$4, [["__scopeId", "data-v-bc5701fa"]]), { __name: "BaseButtonYear" });
function o$1(n) {
      ...
      createElementVNode("div", re, [
        unref(w).tooltip ? renderSlot(e.$slots, "tooltip", {
          ...
          createVNode(T, {
            data: s.value,
            categories: a.categories,
            toolTipTitle: unref(o$1)(s.value) ?? "",
...
/* @__PURE__ */ defineComponent({
  ...
  setup(k, { emit: x2 }) {
    ...
    return (o2, r) => (openBlock(), createElementBlock(Fragment, null, [
      ...
      createElementVNode("div", W, [
        unref(L).tooltip ? renderSlot(o2.$slots, "tooltip", {
          key: 0,
          values: a.value
        }) : a.value ? renderSlot(o2.$slots, "fallback", { key: 1 }, () => [
          createVNode(T, {
            data: a.value,
            categories: e.categories || {},
            toolTipTitle: unref(o$1)(a.value) ?? "",
...
const _sfc_main$3 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      const _component_BarChart = __nuxt_component_1$1;
...
const __nuxt_component_6 = Object.assign(_sfc_main$3, { __name: "BaseChartBarGroup" });
const _sfc_main$2 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      const _component_baseButtonYear = __nuxt_component_0;
      const _component_LineChart = __nuxt_component_1$1;
      _push(`<div${ssrRenderAttrs(_attrs)}>`);
...
const __nuxt_component_7 = Object.assign(_sfc_main$2, { __name: "BaseChartLine" });
const _sfc_main$1 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    const xFormatter = (i) => `${useData.value[i]?.month}`;
    const yFormatter = (tick) => tick.toString();
    return (_ctx, _push, _parent, _attrs) => {
      const _component_baseButtonYear = __nuxt_component_0;
      const _component_BarChart = __nuxt_component_1$1;
...
const __nuxt_component_8 = Object.assign(_sfc_main$1, { __name: "BaseChartBar" });
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      const _component_baseChartBarGroup = __nuxt_component_6;
      const _component_baseChartLine = __nuxt_component_7;
      const _component_baseChartBar = __nuxt_component_8;
...
//# sourceMappingURL=index-COSewMMi.mjs.map
