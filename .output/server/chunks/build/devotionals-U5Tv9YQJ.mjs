...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  async setup(__props) {
    ...
    [__temp, __restore] = withAsyncContext(() => useFetch("/api/user/bible/devotional/all", { key: "all_devotionals" }, "$V-4eQel883")), await __temp, __restore();
...
//# sourceMappingURL=devotionals-U5Tv9YQJ.mjs.map
