import { defineComponent, withAsyncContext, unref, withCtx, createVNode, createBlock, createCommentVNode, openBlock, ref, mergeProps, toDisplayString, computed, useSlots, renderSlot, useSSRContext, useTemplateRef, createElementBlock, normalizeStyle, createElementVNode, Fragment, renderList } from 'vue';
import { ssrRenderAttrs, ssrRenderComponent, ssrInterpolate, ssrRenderClass, ssrRenderSlot } from 'vue/server-renderer';
import { a as useUserSession, d as __nuxt_component_0$3, b as useAppConfig, t as tv, c as __nuxt_component_0$1$1 } from './server.mjs';
import { u as useFetch, _ as __nuxt_component_0$2 } from './Header-BNpLB6jy.mjs';
import { Primitive } from 'reka-ui';
import { _ as _sfc_main$a } from './Container-YnYdMvQP.mjs';
        ...
        default: withCtx((_2, _push2, _parent2, _scopeId) => {
          if (_push2) {
            if (__props.collection === "books") {
              _push2(`<div${_scopeId}><div class="flex flex-col justify-center items-center"${_scopeId}><span${_scopeId}>Started ${ssrInterpolate(books.start)} books</span><span${_scopeId}>Finished ${ssrInterpolate(books.end)} books</span></div></div>`);
            } else {
              _push2(`<!---->`);
            }
            if (__props.collection === "coldSoak") {
              _push2(`<div${_scopeId}><div class="flex flex-col justify-center items-center"${_scopeId}><span${_scopeId}>${ssrInterpolate(coldSoak?.date)}</span></div></div>`);
            } else {
              _push2(`<!---->`);
            }
            if (__props.collection === "fasting") {
              _push2(`<div${_scopeId}><div class="flex flex-col justify-center items-center"${_scopeId}><span${_scopeId}>Duration ${ssrInterpolate(fasting?.duration)} hours</span></div></div>`);
            } else {
              _push2(`<!---->`);
            }
            if (__props.collection === "dailyWater") {
              _push2(`<div${_scopeId}><div class="flex flex-col justify-center items-center"${_scopeId}><span${_scopeId}>${ssrInterpolate(dailyWater?.water)} oz.</span><span${_scopeId}>${ssrInterpolate(dailyWater?.date)}</span></div></div>`);
            } else {
              _push2(`<!---->`);
            }
            if (__props.collection === "weight") {
              _push2(`<div${_scopeId}><div class="flex flex-col justify-center items-center"${_scopeId}><span${_scopeId}>${ssrInterpolate(weight?.weight)} lbs</span><span${_scopeId}>${ssrInterpolate(weight?.date)}</span></div></div>`);
            } else {
              _push2(`<!---->`);
            }
          } else {
            return [
              ...
              __props.collection === "dailyWater" ? (openBlock(), createBlock("div", { key: 3 }, [
                createVNode("div", { class: "flex flex-col justify-center items-center" }, [
                  createVNode("span", null, toDisplayString(dailyWater?.water) + " oz.", 1),
                  createVNode("span", null, toDisplayString(dailyWater?.date), 1)
                ])
              ])) : createCommentVNode("", true),
              __props.collection === "weight" ? (openBlock(), createBlock("div", { key: 4 }, [
                createVNode("div", { class: "flex flex-col justify-center items-center" }, [
                  createVNode("span", null, toDisplayString(weight?.weight) + " lbs", 1),
                  createVNode("span", null, toDisplayString(weight?.date), 1)
                ])
              ])) : createCommentVNode("", true)
            ];
          }
...
//# sourceMappingURL=index-D_rqD9CH.mjs.map
