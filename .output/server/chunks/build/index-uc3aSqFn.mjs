...
const __nuxt_component_1_lazy_visible = createLazyVisibleComponent("components/app/TrackerBibleDevotional.vue", () => import('./TrackerBibleDevotional-C7FNoyV7.mjs').then((c) => c.default || c));
const __nuxt_component_2_lazy_visible = createLazyVisibleComponent("components/app/TrackerBibleSermon.vue", () => import('./TrackerBibleSermon-D3zZ3if3.mjs').then((c) => c.default || c));
const __nuxt_component_3_lazy_visible = createLazyVisibleComponent("components/app/TrackerJournal.vue", () => import('./TrackerJournal-CAc2dpgk.mjs').then((c) => c.default || c));
const _sfc_main = /* @__PURE__ */ defineComponent({
  __name: "index",
  __ssrInlineRender: true,
  async setup(__props) {
    let __temp, __restore;
    [__temp, __restore] = withAsyncContext(() => useFetch("/api/user/profile/setting", { key: "setting" }, "$64zj0RbvUE")), await __temp, __restore();
...
//# sourceMappingURL=index-uc3aSqFn.mjs.map
