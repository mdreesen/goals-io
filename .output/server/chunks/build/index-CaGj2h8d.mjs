import { _ as _sfc_main$4 } from './Drawer-sBacW_ES.mjs';
import { a as useNuxtData, u as useUserSession, d as _sfc_main$9, e as __nuxt_component_0$4, j as refreshNuxtData, g as useAppConfig, r as reactivePick, h as useFormField, t as tv, i as _sfc_main$f } from './server.mjs';
import { i as inputVarient, _ as __nuxt_component_5 } from './Label-BSaw2oj1.mjs';
import { _ as __nuxt_component_6$1 } from './ButtonSubmit-CHrczC4x.mjs';
import { defineComponent, mergeProps, withAsyncContext, ref, reactive, resolveDirective, withCtx, createVNode, unref, withModifiers, withDirectives, createBlock, openBlock, vModelText, createTextVNode, mergeModels, useSlots, useModel, useId, computed, Fragment, createCommentVNode, renderSlot, toDisplayString, resolveDynamicComponent, useSSRContext } from 'vue';
...
const _sfc_main$1 = /* @__PURE__ */ defineComponent({
  ...
  async setup(__props) {
    ...
    [__temp, __restore] = withAsyncContext(() => useFetch("/api/user/profile", { key: "profile", lazy: true }, "$9JsZe7Vhty")), await __temp, __restore();
...
//# sourceMappingURL=index-CaGj2h8d.mjs.map
