...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  async setup(__props) {
    ...
    const { data, pending: pending_data } = ([__temp, __restore] = withAsyncContext(() => useFetch(`/api/user/bible/devotional/${route.params.id}`, { lazy: true }, "$37l6F0aa7h")), __temp = await __temp, __restore(), __temp);
...
//# sourceMappingURL=devotional-E0p_tQX_.mjs.map
