...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  async setup(__props) {
    ...
    const { data, pending: pending_data } = ([__temp, __restore] = withAsyncContext(() => useFetch(`/api/user/bible/sermon/${route.params.id}`, { lazy: true }, "$5OXwIqLNIj")), __temp = await __temp, __restore(), __temp);
...
//# sourceMappingURL=sermon-ByroWDKy.mjs.map
