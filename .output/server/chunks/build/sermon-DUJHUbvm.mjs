import { m as useRoute, u as useUserSession, b as __nuxt_component_0, r as refreshNuxtData, n as navigateTo } from './server.mjs';
...
import { _ as __nuxt_component_3, a as __nuxt_component_4 } from './ButtonDelete-BPVRyx_x.mjs';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  async setup(__props) {
    ...
    const { data, pending: pending_data } = ([__temp, __restore] = withAsyncContext(() => useFetch(`/api/user/journal/${route.params.id}`, "$5OXwIqLNIj")), __temp = await __temp, __restore(), __temp);
...
//# sourceMappingURL=sermon-DUJHUbvm.mjs.map
