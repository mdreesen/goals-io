...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  async setup(__props) {
    ...
    [__temp, __restore] = withAsyncContext(() => useFetch("/api/user/journal/journal", { key: "journal", lazy: true }, "$veQ4EUSzfu")), await __temp, __restore();
...
//# sourceMappingURL=TrackerJournal-DTRKRdzW.mjs.map
