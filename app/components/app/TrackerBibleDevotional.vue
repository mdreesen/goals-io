...
await useFetch('/api/user/bible/devotional', { key: 'devotional', lazy: true });
    ...
    <div class="flex flex-col items-center justify-center w-full   mx-auto p-8 font-sans">
      ...
      <div class="w-full relative mb-4 flex flex-col justify-center items-center gap-4">
        ...
        <transition name="slide-up" mode="out-in">
          ...
          <UDrawer title="Log a new devotional entry" v-model:open="open">
            <baseButtonDrawer text="Add devotional entry" icon="material-symbols:shield-spark-rounded" />
