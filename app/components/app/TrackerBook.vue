<script setup lang="ts">
  ...
  <template>
    <div class="relative flex flex-col h-[750px] w-full max-w-md mx-auto bg-zinc-950 rounded-[40px] overflow-hidden border border-white/5 shadow-2xl font-sans">
      ...
      <div class="relative z-10 pl-8 mb-8">
        <div class="flex gap-4 overflow-x-auto pb-8 pt-4 pr-8 snap-x scrollbar-hide">
          ...
          >
            <div 
              class="w-20 h-28 rounded-lg shadow-lg mb-3 relative transition-all duration-300 transform"
              :class="[
                book.coverGradient,
            ...
            >
              ...
              <div v-if="book.status === 'read'" class="absolute -top-2 -right-2 bg-black rounded-full border border-zinc-800 p-1">
                <CheckCircle class="w-3 h-3 text-emerald-500" />
              </div>
            </div>
            
            <div class="w-20 text-center transition-opacity duration-300" :class="selectedBookId === book.id ? 'opacity-100' : 'opacity-0'">
      ...
      <div class="flex-1 relative z-10 flex flex-col items-center px-8">
        ...
        <div class="perspective-1000 mb-8">
          ...
          >
            ...
            <div v-if="isCompleted" class="absolute top-4 right-4 bg-emerald-500/20 backdrop-blur-md p-2 rounded-full border border-emerald-500/50">
          ...
          <div class="space-y-2">
            <div class="flex gap-[2px] h-2 w-full opacity-80">
              <div 
                ...
                :class="i <= progressSegments.active ? 'bg-white' : 'bg-zinc-800'"
              ></div>
            </div>
      ...
      <div class="p-6 relative z-20">
        ...
        <div v-else-if="activeBook.status === 'read'" class="w-full h-14 bg-emerald-500/10 border border-emerald-500/20 rounded-xl flex items-center justify-center gap-2">
        ...
        <div v-else class="w-full h-14 bg-indigo-500/10 border border-indigo-500/20 rounded-xl flex items-center justify-center gap-2 group cursor-pointer hover:bg-indigo-500/20 transition-colors">
