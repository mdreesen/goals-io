...
export default function AffirmationForm({ data }: any) {
    const router = useRouter();

    const [error, setError] = useState<string>();
    const [affirmationData, setAffirmationData] = useState<TypeAffirmation>({ ...data });
    ...
    const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
        ...
        try {
            ...
            await addAffirmation({ ...affirmationData });
    ...
    return (
        ...
        >
            ...
            <div className="flex w-full max-w-lg space-x-4">
                <ButtonDeleteAffirmation data={affirmationData} />
            </div>
