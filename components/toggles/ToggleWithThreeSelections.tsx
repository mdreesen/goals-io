...
export default function ToggleWithThreeSelections({ data }: any) {
  ...
  return (
    <Switch
      ...
      className="group relative inline-flex h-6 w-11 shrink-0 cursor-pointer rounded-full border-2 border-transparent bg-gray-200 transition-colors duration-200 ease-in-out focus:outline-none focus:ring-2 focus:ring-gray-900 focus:ring-offset-2 data-[checked]:bg-gray-900"
    >
      ...
      <span className="pointer-events-none relative inline-block size-5 transform rounded-full bg-white shadow ring-0 transition duration-200 ease-in-out group-data-[checked]:translate-x-5">
        ...
        >
          <svg fill="currentColor" viewBox="0 0 12 12" className="size-3 text-gray-900">
